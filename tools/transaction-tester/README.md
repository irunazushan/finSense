...
- if a selected category has no MCC templates in the generator catalog, requested `low_confidence` events fall back to `normal` and a warning is shown in the summary
