...
* Structured logging
* Хранение AI-логов в файловой системе
...
* PostgreSQL
* Docker
* Внешний LLM API (DeepSeek)
* REST API
* JSON
* ONNX Runtime для ML-инференса
...
8. Общий Postgres с разными схемами для прототипа
...
Текущая архитектура упрощена для прототипа, но допускает эволюцию без полной переработки системы.
